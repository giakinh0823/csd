...
public class ListBooking {
    ...
    public ListBooking(TTree listTrain, ListCustomer listCustomer) {
        head = null;
        tail = null;
    ...
    public void display() {
        ...
        while (node != null) {
            ...
            Customer customer = listCustomer.searchCode(node.getData().getCcode());
    ...
    public Customer findByCodeCustomer(String code) {
        Customer customer = listCustomer.searchCode(code);
        if(customer!=null){
            return customer;
        }
        return null;
